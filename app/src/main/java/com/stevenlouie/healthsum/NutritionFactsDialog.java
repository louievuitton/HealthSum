...
public class NutritionFactsDialog extends AppCompatDialogFragment {
    ...
    private Meal meal;
    private TextView numServingsValue, numCaloriesValue, totalFatsValue, saturatedFatValue, cholesterolValue, sodiumValue, totalCarbsValue, dietaryFiberValue, totalSugarsValue, proteinValue;
